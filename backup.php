          ...
          <ul class="navbar-nav mr-auto">
            ...
            <!-- <li class="nav-item">
              <a class="nav-link waves-effect" href="https://mdbootstrap.com/docs/jquery/getting-started/download/"
                target="_blank">Preparation demande backup</a>
            </li> -->
            <!-- <li class="nav-item">
              <a class="nav-link waves-effect" href="https://mdbootstrap.com/education/bootstrap/" target="_blank">Preparation demande MEP</a>
            </li> -->
          </ul>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush">
        <a href="#" class="list-group-item active waves-effect">
          <i class="fas fa-chart-pie mr-3"></i>localhost
        </a>
        <!-- <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-user mr-3"></i>Profile</a> -->
        <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-table mr-3"></i>Preparation demande MEP</a>
        <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-map mr-3"></i>Preparation demande backup</a>
        <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-money-bill-alt mr-3"></i>Historiques</a>
      </div>
                  ...
                  <div class="card-body">
                    ...
                    <div>
                      <div class="flex-center flex-column">
                        <h1 class="text-hide animated fadeIn mb-4">Localhost</h1>
                        <!--<h5 class="animated fadeIn mb-3">Mah</h5>-->
                      
                        <div class="w-100">
                          <h4 class="mb-2 mb-sm-0 pt-1">
                            <!-- <a href="https://mdbootstrap.com/docs/jquery/" target="_blank">Home Page</a> -->
                            <span>C:/xampp/htdocs/MAHERY/</span>
                          </h4>
                           <form class="d-flex justify-content-center" action="./backup.php" methode="GET">
                            <!-- Default input -->
                            <input type="text" placeholder="Tcopier le chemin du repertoire" name="chemin" style="width:65%"aria-label="Search" class="form-control">
                            <button class="btn btn-primary btn-sm my-0 p" type="submit">Voir l'arborescence
                              <!-- <i class="fas fa-search"></i> -->
                            </button>

                          </form>
                          <!-- <form ><input type="text" name="chemin" style="width:65%">
                            <button>Voir l'arborescence</button>
                          </form> -->
                        </div>
                        <?php
                          $chemin_generale = $_SERVER['DOCUMENT_ROOT'].'MAHERY/';
                          if(isset($_GET['chemin']))
                          {
                            $chemin_rep = str_replace("\\","/",$_GET['chemin']);
                            $chemin_rep = trim($chemin_rep, '/');
                            $chemin_generale .= $chemin_rep.'/';
                            ?>
                            <table class="php-file-tree" style="min-height:750px">
                              <tr>
                                <td valign="top"><ul><li class="pft-directory"><?php echo $chemin_rep;?></li></ul></td>
                                <td valign="top"><?php echo php_file_tree($chemin_generale, "javascript:alert('[link]');");?></td>
                              </tr>
                            </table>
                            <?php
                          }
